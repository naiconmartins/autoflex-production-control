...
public class ProductRawMaterialServiceImplImplTest {
  ...
  void add_shouldThrowConflictException_whenLinkAlreadyExists() {
    ...
    ProductRawMaterial existingLink =
        ProductRawMaterialFactory.createLink(product, rawMaterial, BigDecimal.ONE);
  ...
  void listByProduct_shouldReturnList_whenProductExists() {
    ...
    ProductRawMaterial link =
        ProductRawMaterialFactory.createLink(product, rawMaterial, BigDecimal.TEN);
    PanacheQuery query = mock(PanacheQuery.class);
  ...
  void updateRequiredQuantity_shouldUpdate_whenLinkExists() {
    ...
    ProductRawMaterialResponseDTO result =
