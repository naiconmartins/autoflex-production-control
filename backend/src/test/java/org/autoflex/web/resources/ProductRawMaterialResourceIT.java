...
public class ProductRawMaterialResourceIT {
    ...
    void setUp() {
        ...
        RawMaterial otherRawMaterial = new RawMaterial(otherRmCode, "PRM Other Raw Material", new BigDecimal("100.00"));
    ...
    void add_shouldReturn201_whenValidRequest() {
        ProductRawMaterialRequestDTO request = new ProductRawMaterialRequestDTO(rawMaterialId, new BigDecimal("1.00"));
