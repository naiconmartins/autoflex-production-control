...
public class UserResourceIT {
  ...
  void insert_shouldPersistUser_whenAdmin() {
    UserRequestDTO request = new UserRequestDTO(userEmail, "pass123", "Admin", "IT", "ADMIN");
  ...
  void insert_shouldReturn409_whenEmailExists() {
    UserRequestDTO request = new UserRequestDTO(userEmail, "other", "Other", "Name", "USER");
  ...
  void insert_shouldReturn422_whenRoleIsInvalid() {
    UserRequestDTO request =
        new UserRequestDTO("invalid-role@test.com", "123", "Test", "Role", "GOD_MODE");
  ...
  void insert_shouldReturn422_whenEmailIsInvalid() {
    UserRequestDTO request = new UserRequestDTO("email-without-at", "123", "John", "Doe", "USER");
  ...
  void insert_shouldReturn422_whenPasswordIsBlank() {
    UserRequestDTO request =
        new UserRequestDTO(UserFactory.uniqueEmail(), "", "John", "Doe", "USER");
